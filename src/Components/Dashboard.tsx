    ...
    return (
        <div className="min-h-screen bg-[#0f0f0f] flex flex-col">
            ...
            <div className="flex flex-1">
                ...
                <div className="flex-1 bg-[#161618] border border-[#3b3b3b] text-white p-6 overflow-y-auto">
                    <div className={`transition-all duration-300 ${isEditingOpen ? 'blur-sm' : ''}`}>
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <button 
                                    ...
                                    className="bg-[#242424] border border-[#3a3a3a] text-white px-4 py-2 rounded text-sm hover:bg-[#3a3a3a] transition-colors"
                                >
                                    Edit Variables
                                </button>
                        ...
                        <div className="mb-8">
                            <h2 className="text-[#dafd7e] text-lg font-semibold mb-4">Best Scenario Results</h2>
                            <div className="space-y-3">
                                {scenarios && scenarios.map((scenario: Scenario) => (
                                    <div key={scenario.id} className="bg-[#161618] border border-[#4a5c2a] rounded-lg p-4">
                                        <div className="flex justify-between items-start">
                                            <p className="text-[#9acd32] text-sm flex-1 pr-4">{scenario.title}</p>
                                            <button 
                                                onClick={() => toggleScenario(scenario.id)} 
                                                className="text-gray-400 hover:text-white transition-colors"
                                            >
                                                <MoreHorizontal className="w-5 h-5 text-[#9acd32]" />
                                            </button>
                                        </div>
                                        {expandedScenario === scenario.id && (
                                            <div className="mt-4 pt-4 border-t border-[#4a5c2a]">
                        ...
                        <div className="flex space-x-6">
                            ...
                            <div className="w-[60%]">
                                ...
                                <div className="flex items-center space-x-3 mb-4">
                                    <h3 className="text-white text-xl font-semibold">Graphs</h3>
                                    {singleChart && (
                                        <div className="flex items-center space-x-2">
                                            <div 
                                            ...
                                            ></div>
                                            <span className="text-gray-400 text-sm">{singleChart.name}</span>
                                        </div>
                                    )}
                                </div>
                                
                                {/* Chart container with border */}
                                <div className="bg-[#161618] border border-[#2a2a2a] rounded-lg p-6">
                                    ...
                                    <div className="flex justify-end items-center mb-4">
                                        <select 
                                            ...
                                            className="bg-[#242424] border border-[#3a3a3a] text-white px-3 py-2 rounded text-sm focus:outline-none focus:border-[#5a5a5a]"
                                        >
                                        ...
                                        {singleChart ? (
                                            ...
                                            <div className="flex items-center justify-center h-full">
                                                <div className="text-center">
                                                    <p className="text-gray-400 text-lg mb-2">No variables selected</p>
                                                    <p className="text-gray-500 text-sm">Select variables to view chart data</p>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                            ...
                            <div className="w-[40%]">
                                ...
                                <div className="flex justify-between items-center mb-4">
                                    <h3 className="text-white text-xl font-semibold">Key Performance Indicators</h3>
                                    <button 
                                        onClick={handleEditVariables}
                                        className="flex items-center space-x-1 bg-[#242424] border border-[#3a3a3a] text-gray-300 px-3 py-1.5 rounded text-sm hover:bg-[#3a3a3a] transition-colors"
                                    >
                                        <span>Variables</span>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        {activeKPIs.length > 0 ? activeKPIs.map((kpi: KPI, index: number) => (
                                            <div 
                                                ...
                                                className={`rounded-lg p-4 relative transition-all cursor-pointer ${
                                                    kpi.isPrimary 
                                            ...
                                            >
                                                ...
                                                <div className={`absolute bottom-3 right-3 w-2 h-2 rounded-full transition-all ${
                                                    kpi.isPrimary 
                                        ...
                                        {singleChart && (
                                            <div className="mt-3 text-center">
                                                <p className="text-gray-500 text-xs">
                                                    Showing: <span className="text-[#9acd32]">{singleChart.name}</span> | Click KPI cards to switch
                                                </p>
                                            </div>
                                        )}
                                    </div>
