...
const VariableEditing: React.FC<VariableEditingProps> = ({ isOpen, onClose, activeVariables }) => {
  ...
  return (
    <>
      ...
      {/* Slide Over Panel */}
      <div className={`
        fixed right-0 top-0 h-full w-[600px] bg-[#0e0d0d] border-l border-[#383838] z-50
      ...
      `}>
          ...
          <div className="flex space-x-2 mb-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-[#0e0d0d] border border-gray-600 rounded text-white placeholder-gray-400 focus:outline-none focus:border-[#9acd32] text-sm"
              />
            </div>
            <button
              onClick={handleReset}
              className="px-3 py-2 bg-[#0e0d0d] border border-[#383838] text-white rounded hover:bg-[#3a3a3a] transition-colors text-sm"
            >
              Autofill
            </button>
            <button
              onClick={handleSave}
              className="flex items-center space-x-2 px-4 py-2 bg-[#9acd32] text-black rounded hover:bg-[#8bc34a] transition-colors text-sm font-medium"
            >
        ...
        {/* Variable Categories Section - Like in your image */}
        <div className="p-4 space-y-4">
          {/* Variable Category 1 */}
          <div className="space-y-2">
            <h3 className="text-gray-400 text-sm">Variable category 1</h3>
          ...
          {/* Variable Category 2 */}
          <div className="space-y-2">
            <h3 className="text-gray-400 text-sm">Variable Category 2</h3>
            <div className="flex flex-wrap gap-2">
          ...
          {/* Variable Category 3 */}
          <div className="space-y-2">
            <h3 className="text-gray-400 text-sm">Variable Category 3</h3>
            <div className="flex flex-wrap gap-2">
          ...
          {/* Context Window */}
          {hoveredVariable && (
            <div className="p-4 bg-[#222324] border border-[#28292a] rounded-lg">
              <div className="flex items-start justify-between mb-2">
                <h4 className="text-white font-semibold text-lg">
                  {hoveredVariable.name}
                </h4>
                <div className="w-4 h-4 rounded-full border border-[#28292a] flex items-center justify-center">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="bg-[#161618] border border-[#383838] rounded-lg overflow-hidden">
            ...
            >
              <span className="text-[#b4d067] font-medium">Primary Variables</span>
          ...
          <div className="bg-[#161618] border border-[#383838] rounded-lg overflow-hidden">
            <button
              ...
              className="w-full flex items-center justify-between p-4 text-left transition-colors"
            >
              <span className="text-[#b4d067] font-medium">Secondary Variables</span>
        ...
        <div className="p-4 border-t border-[#383838] bg-[#0e0d0d]">
          <div className="flex space-x-2">
            <button
              onClick={handleSave}
              className="flex-1 bg-[#9acd32] text-black py-2 px-4 rounded font-medium hover:bg-[#8bc34a] transition-colors text-sm"
            >
              Apply Changes
            </button>
            <button
              onClick={onClose}
              className="flex-1 bg-[#242424] text-white py-2 px-4 rounded border border-[#3a3a3a] hover:bg-[#2a2a2a] transition-colors text-sm"
            >
              Cancel
            </button>
          </div>
